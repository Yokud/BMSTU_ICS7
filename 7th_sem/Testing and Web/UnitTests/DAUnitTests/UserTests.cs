...
namespace UnitTests
{
    ...
    public class UserTests
    {
        ...
        public UserTests()
        {
            ...
            _contextMock.Users.Add(new UserObjectMother().ExistingUserHerrington());
            _contextMock.Users.Add(new UserObjectMother().ExistingUserDarkholme());
        ...
        [AllureXunitTheory]
        [InlineData(1, "BillyHerrington", "123", "BillyHerrington", "BillyHerrington@gmail.com", "@BillyHerrington", 8)]
        ...
        {
            // Arrange
            DateTime dateOfBirth = DateTime.ParseExact("1969-07-14", "yyyy-MM-dd",
        ...
        [AllureXunitTheory]
        [InlineData(1, "BillyHerrington", "123", "BillyHerrington", "BillyHerrington@gmail.com", "@BillyHerrington", 8)] // todo: inline data списком
