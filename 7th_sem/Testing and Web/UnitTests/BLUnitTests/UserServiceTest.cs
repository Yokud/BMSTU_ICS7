...
namespace UnitTests
{
    ...
    public class UserServiceTest
    {
        ...
        {
            // Arrange
            User expectedUser = new UserObjectMother().ExistingUserHerrington();
        ...
        public void TestGetAll()
        {
            ...
            {
                new UserObjectMother().ExistingUserHerrington(),
                new UserObjectMother().ExistingUserDarkholme(),
        ...
        {
            // Arrange
            User user = new UserObjectMother().ExistingUserHerrington();
