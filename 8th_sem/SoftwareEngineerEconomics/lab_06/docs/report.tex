...
\begin{document}
	...
	\begin{titlepage}
		...
		\noindent\textbf{Тема} $\underline{\text{Предварительная оценка параметров программного проекта}}$\newline\newline
		%\indent\indent $\underline{\text{}}$\newline\newline
		\noindent\textbf{Студент} $\underline{\text{Малышев И. А.}}$\newline\newline
		\noindent\textbf{Группа} $\underline{\text{ИУ7-81Б}}$\newline\newline
		\noindent\textbf{Вариант} $\underline{\text{1}}$\newline\newline
