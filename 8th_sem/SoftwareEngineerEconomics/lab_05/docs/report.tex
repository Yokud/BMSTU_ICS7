...
\begin{document}
	...
	\begin{titlepage}
		...
		\noindent\textbf{Тема} $\underline{\text{Контроль хода выполнения проекта с помощью средств анализа затрат.}}$\newline\newline
		\indent\indent $\underline{\text{Анализ рисков по методу PERT. Работа с отчетами}}$\newline\newline
